...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const item = { sponsorshipId, startAt: start.toISOString(), endAt: end.toISOString(), story, status: 'scheduled', source: sourceTag('football200-admin'), createdAt: new Date().toISOString() };
