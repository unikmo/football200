# Sponsor a Young Fan — Canonical Truth Registry

This file records the current authoritative project decisions. Future product, design, website, and implementation work should not silently overwrite these values.
...
| Homepage primary audience | Football clubs | LOCKED |
...
Participating clubs must visibly recognize the programme for the season by linking to the Sponsor a Young Fan club/season sponsor page or publishing participating company names on the club website; ideally both.
...
Participating clubs commit contractually to reinvesting at least **30% of their Sponsor a Young Fan programme proceeds** into improvements that directly enhance the matchday experience for children and families.

This is primarily a club contractual/operating requirement, **not homepage marketing copy**.

Examples: games/football activities, family areas, child-friendly food/drink offers, weather protection, small prizes/materials, meet-and-greets, halftime and post-match experiences.
...
Volunteer recruitment does not belong inside Sponsor a Young Fan. It is handled through the separate `RunYourEvent` service.
...
An approved child/family matchday photo/story may be made available to a sponsor only through a valid parent/guardian consent and rights process. The exact German implementation requires qualified legal review before production.

**REQUIRES QUALIFIED LEGAL REVIEW before implementation.**

## Sponsor analytics

The initial sponsor offering should remain simple. Do not make the core product depend on dashboards, detailed attendance analytics, impression metrics, complicated ROI reporting, or weekly statistics.
...
The current demo is deliberately non-production: no real payments, no persistent child applications, no real child/family data, no legal consent workflow, no real insurance promises, `noindex`/`nofollow`, and production requires separate explicit approval after live-demo approval and QA.
